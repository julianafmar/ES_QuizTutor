        ...
        if (targetDomainObject instanceof Integer) {
            ...
            switch (permissionValue) {
                ...
                case "DASHBOARD.UPDATE":
                    TeacherDashboard teacherDashboardUp = teacherDashboardRepository.findById(id).orElse(null);
                    return teacherDashboardUp != null && teacherDashboardUp.getTeacher().getId().equals(userId);
                default:
                    return false;
            }
        }
