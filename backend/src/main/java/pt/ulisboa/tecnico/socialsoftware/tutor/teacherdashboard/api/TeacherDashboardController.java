...
public class TeacherDashboardController {
    ...
    @DeleteMapping("/teachers/dashboards/{dashboardId}/remove")
    @PreAuthorize("hasRole('ROLE_TEACHER') and hasPermission(#dashboardId, 'DASHBOARD.REMOVE')")
    ...
    @PreAuthorize("hasRole('ROLE_TEACHER') and hasPermission(#dashboardId, 'DASHBOARD.UPDATE')")
